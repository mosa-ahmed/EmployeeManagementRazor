...
namespace EmployeeManagementRazor.Pages.Employees
{
    public class EditModel : PageModel
    {
        ...
        public IActionResult OnPostUpdateNotificationPreferences(int id)
        {
            ...
            //since we are using TempData to pass the confirm message, we no longer have to pass it in the url as a QS parameter.
            //TempData is temporary, it's only available for a given request, once Data is read from TempData, it's Deleted and
            //no longer available for subsequent requests
            //, message = Message
